...
from app.services.storage_manager import download_zip
...
def run_pipeline(
    ...
    try:
        ...
        # Story 1.3 — run tabular extraction while the workspace (and the PDFs it
        # holds) still exists. Must complete before the finally block wipes /tmp.
