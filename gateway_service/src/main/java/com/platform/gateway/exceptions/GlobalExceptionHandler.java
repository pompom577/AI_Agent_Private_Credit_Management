...
public class GlobalExceptionHandler {
    ...
    // Covers S3 credential / network failures surfaced by StorageStreamService.
    @ExceptionHandler(IllegalStateException.class)
    public ResponseEntity<ErrorResponse> handleStorageUnavailable(IllegalStateException ex) {
